...
\justify{Minima of the above equation (1), can be calculated from the following expression,}
...
\justify{Maxima of the above equation (1), can be calculated from the following expression,}
